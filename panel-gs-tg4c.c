...
static const struct gs_dsi_cmd tg4c_init_cmds[] = {
	...
	/* DBI */
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xC2, 0x33, 0x00),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0x6F, 0x03),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xC2, 0x77, 0x1F, 0x02, 0x00, 0x9E, 0xB8,
					0xCA, 0xD8, 0xE4, 0xF0, 0xFA, 0x00, 0x1D, 0x00, 0x00, 0x01),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xC3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
	...
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xC5, 0x88, 0x00, 0x00, 0x88, 0x00, 0x00,
					0x88, 0x00, 0x00, 0x08, 0x00, 0x88, 0x00, 0x00, 0x88, 0x00, 0x00, 0x88,
					0x00, 0x00, 0x08, 0x00, 0x88, 0x00, 0x00, 0x88, 0x00, 0x00, 0x88, 0x00,
					0x00, 0x08, 0x00),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xC6, 0xF8, 0x00, 0xFF, 0x88, 0x00, 0x00,
					0x88, 0x00, 0x00, 0xF8, 0x00, 0xFF, 0x88, 0x00, 0x00, 0x88, 0x00, 0x00,
					0xF8, 0x00, 0xFF, 0x88, 0x00, 0x00, 0x88, 0x00, 0x00),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xC7, 0x15),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xC8, 0x00, 0x00, 0x00, 0x01, 0x02, 0x03,
					0x06, 0x0D, 0x1A, 0x34),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xC9, 0x00, 0x01, 0x02, 0x04, 0x08, 0x10,
					0x1F, 0x3F, 0x7D, 0xFA),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xCA, 0x00, 0x01, 0x01, 0x02, 0x04, 0x09,
					0x12, 0x24, 0x47, 0x8E),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xCB, 0x21, 0x38, 0x55, 0x64, 0x2B, 0x92,
					0xCA, 0x5F, 0xE8, 0xFE, 0x59, 0x4A, 0xFF, 0x37, 0x89, 0xFE, 0x2D, 0xFF,
					0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
					0xFF, 0xFF, 0xFF),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xCC, 0x00, 0x60, 0xB9, 0x21, 0x56, 0x42,
					0x43, 0x1B, 0xD8, 0x86, 0x3A, 0xAC, 0xCA, 0x91, 0x86, 0xFD, 0xF4, 0xFF,
					0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
					0xFF, 0xFF, 0xFF),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xCE, 0x21, 0x1B, 0x16, 0x43, 0x81, 0xD3,
					0xA7, 0xB2, 0x73, 0xAA, 0xAE, 0xF5, 0xBB, 0xCC, 0x3D, 0xF9, 0xA1, 0xFF,
					0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
					0xFF, 0xFF, 0xFF),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xCF, 0x88, 0x78, 0x78, 0x78, 0x78, 0x7E,
	...
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0x6F, 0x32),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xCF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	...
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0x6F, 0x64),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xCF, 0x38, 0x00, 0x12, 0x00, 0xDB, 0x11,
	...
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0x6F, 0x96),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xCF, 0x38, 0x5E, 0x3C, 0x13, 0x3C, 0x2F),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xD0, 0x44, 0x00, 0x00, 0x44, 0x00, 0x00,
					0x44, 0x00, 0x00, 0x44, 0x00, 0x00, 0x44, 0x00, 0x00, 0x44, 0x00, 0x00,
					0x44, 0x00, 0x00, 0x44, 0x00, 0x00, 0x44, 0x00, 0x00, 0x44, 0x00, 0x00),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xD2, 0x00),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xD3, 0x00),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xFF, 0xAA, 0x55, 0xA5, 0x84),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0x6F, 0x26),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xF2, 0x00),
